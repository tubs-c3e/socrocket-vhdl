import usi.api.parameter as cci
import timeit
...
if __name__ ==  '__main__':
    ##set path
    temp_path = 'SysCtoVHDL/templates'
    grlib_design_path= 'designs/leon3mp'
    dst_design_path = 'VHDL/designs/leon3mp'
    ##Read Property
    ...
    ##Exist the folder?
    if os.path.exists('VHDL') == True:
        shutil.rmtree('VHDL')       # Delete folder
